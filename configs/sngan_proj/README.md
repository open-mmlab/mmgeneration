...
|     Models     | Dataset  | Inplace ReLU | n_disc | Total Iters | IS\*\* | FID\*\* | IS\*\*\* | FID\*\*\* |                                                           Download                                                           |                                Original Download link                                |
| :------------: | :------: | :----------: | :----: | :---------: | :----: | :-----: | :------: | :-------: | :--------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------: |
