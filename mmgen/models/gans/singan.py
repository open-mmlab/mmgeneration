...
class SinGAN(BaseGAN):
    ...
    def train_gan(self, inputs_dict: dict, data_sample: List[GenDataSample],
        ...
        Args:
            ...
            data_sample (List[GenDataSample]): List of data sample contains GT
