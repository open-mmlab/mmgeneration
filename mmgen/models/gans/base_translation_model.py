...
class BaseTranslationModel(BaseGAN):
    ...
    Args:
        ...
        default_style (str): Default output style.
        reachable_styles (list[str], optional): Styles that can be generated by
            the model. Defaults to [].
        related_styles (list[str], optional): Styles involved in training and
            testing. Defaults to [].
    ...
    def translation(self, image, style=None, **kwargs):
        ...
        Args:
            ...
            style (str, optional): Target style. Defaults to None.
